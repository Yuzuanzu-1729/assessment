...
// ツイートボタンを作成するエリア-HTMLにつけたIDと同じ名前にしとかないと謎のエラーで悩まされるよ！ //
...
// ca href = 'https://twitter.com/intent/tweet?button_hashtag=あなたのいいところ&ref_src=twsrc%5Etfw")</a> 
anchor.setAttribute('class', 'twitter-hashtag-button');
// ca href = 'https://twitter.com/intent/tweet?button_hashtag=あなたのいいところ&ref_src=twsrc%5Etfw") class = "twitter - hashtag - button">　</a>
...
const answers = [
  ...
  "{userName}のいいところは純粋さです。{userName}の純粋さに周りのみんなが感化されます。",
  "{userName}のいいところはよく眠れるところです。{userName}の睡眠の深さには誰もかないません！",
  "{userName}のいいところは負けず嫌いなところです。勝てるまで頑張り続ける{userName}は素晴らしいです！",
  "{userName}のいいところは積極的なところです。{userName}は絶対にチャンスを逃しません！",
  "{userName}のいいところはリーダーシップです。{userName}のカリスマ性にみんなが惹かれます。",
  "{userName}のいいところは雰囲気です。{userName}の良い雰囲気はみんなを安心させます。"
];
